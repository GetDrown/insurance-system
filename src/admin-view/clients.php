        ...
        <div>
            <form action="../../phpscript/addcustomer.php" method="POST" class="flex flex-col px-3">
                ...
                <div class="flex justify-around items-center ">
                    ...
                    <button type="button" data-close-clients-modal class="bg-red-300 py-2 px-2 rounded-lg font-medium w-[100px] shadow-md">Cancel</button>
                </div>
            </form>
        </div>
    </dialog>
                    ...
                    <?php for ($i = 0; $i < 3; $i++) { ?>
                        <tr>
                            ...
                            <td class="py-3 border border-lime-500 text-center flex items-center justify-center">
                                <div class="bg-red-400 flex justify-center items-center w-[100px] rounded-md overflow-hidden border border-gray-300">
