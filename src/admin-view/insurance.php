...
<body>
        ...
        <div>
            ...
            <form action="../../phpscript/addinsurances.php" method="POST" class="flex flex-col px-3">
                ...
                <div class="h-[45px] flex mb-5 w-full">
                    <select name="policy_selection" id=""
                        class="rounded-md px-[6px] py-[7px] bg-white border-[3px] w-full">
                ...
                <div class="h-[35px] flex mb-5">
                    <div
                        ...
                        Quantity</div>
                    <input name="policy_quantity" type="text"
    ...
    <div class="basis-5/6  h-dvh p-3 rounded-lg overflow-hidden bg-gray-200 flex flex-col">
        ...
        <div class="h-full rounded-md overflow-y-auto bg-white drop-shadow-md p-5 grid grid-cols-1 gap-5 relative"
            id="clientContainer">
            <p id="noClientsMessage"
                class="absolute inset-0 text-gray-500 <?php echo empty($allPolicy) ? "" : 'hidden'; ?>">"No
                Policy Found"</p>
            <?php foreach ($allPolicy as $i => $policy) { ?>
            <div
                class="client bg-white  rounded-md drop-shadow-md p-5 flex justify-between items-center border-t border-gray-200">
