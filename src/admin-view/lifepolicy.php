                ...
                <div class="mt-4">
                    <div class="flex flex-col h-[730px] border-2 rounded-md">
                            ...
                            <div class="grid grid-cols-2 gap-7">
                                <div class="flex flex-col space-y-2">
                                    ...
                                    <input type="text" placeholder="Name of Applicant.."
                                        class="rounded-md w-full py-[2px] px-[4px] placeholder:pl-[2px] placeholder:text-sm bg-white border-2 border-slate-300 focus:ring-1 focus:outline-none focus:border-lime-500 focus:ring-lime-500">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    <label for="" class="text-[16px]">Present/Business Address:</label>
                                    <input type="text" placeholder="Present/Business Address"
                                        class="rounded-md w-full py-[2px] px-[4px] placeholder:pl-[2px] placeholder:text-sm bg-white border-2 border-slate-300 focus:ring-1 focus:outline-none focus:border-lime-500 focus:ring-lime-500">
                                </div>
                            </div>
                        </div>
                        <div class="mt-4 ml-4 pr-2">
                            <div class="grid grid-cols-2 gap-7">
                                <div class="flex flex-col space-y-2">
                                    <label for="" class="text-[16px]">Permanent/Official Mailing Address: <p
                                            class="text-[12px]">(leave blank if same with Present/Business Address)</p>
                                    </label>
                                    <input type="text" placeholder="Permanent/Official Mailing Address"
                                        class="rounded-md w-full py-[2px] px-[4px] placeholder:pl-[2px] placeholder:text-sm bg-white border-2 border-slate-300 focus:ring-1 focus:outline-none focus:border-lime-500 focus:ring-lime-500">
                                </div>
                        ...
                        <div class="mt-4 ml-4 pr-2">
                            <div class="grid grid-cols-3 gap-7">
                                <div class="flex flex-col space-y-2">
                                    ...
                                    <input type="text" placeholder="Source of Funds"
                                        class="rounded-md w-full py-[2px] px-[4px] placeholder:pl-[2px] placeholder:text-sm bg-white border-2 border-slate-300 focus:ring-1 focus:outline-none focus:border-lime-500 focus:ring-lime-500">
                                </div>
                                <div class="flex flex-col space-y-2">
                                    ...
                                    <div class="flex flex-col items-start mt-4 space-y-4">
                                        <div class="flex items-center">
                                            <input type="radio" name="civil_status"
                                                class="w-[20px] h-[20px] accent-lime-200">
                        ...
                        <div class="mt-4 ml-4 pr-2">
                            <div class="grid grid-cols-3 gap-7">
                                ...
                                <div class="flex flex-col space-y-2">
                                    ...
                                    <input type="text" placeholder="Name of Trustee"
                                        class="rounded-md w-full py-[2px] px-[4px] placeholder:pl-[2px] placeholder:text-sm bg-white border-2 border-slate-300 focus:ring-1 focus:outline-none focus:border-lime-500 focus:ring-lime-500">
                                </div>
                            </div>
                        </div>
                        <div class="mt-6">
                            <div class="flex flex-row justify-center space-x-4">
                                <button type="submit"
                                    class="bg-lime-300 rounded-md px-4 py-2 text-center text-[18px]">Submit
                                    Application</button>
                                <button type="submit"
                                    class="bg-red-300 rounded-md px-4 py-2 text-center text-[18px]">Cancel</button>
                            </div>
