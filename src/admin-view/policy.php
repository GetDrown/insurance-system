...
<body class="bg-gray-300">
    ...
    <div class=" basis-5/6 h-dvh flex flex-col justify-start items-center py-3 px-5 overflow-auto">
        ...
        <div class="h-[1000px] w-full bg-white rounded-lg border p-3 drop-shadow-md flex flex-col ">
            ...
            <form action="" class="flex flex-col ">
                <div class="flex flex-row space-x-6 ml-[10px] mb-[25px]">
                ...
                <div class="flex flex-row ml-[10px] space-x-4 mb-[25px]">
                    <div class="flex flex-col space-y-2">
                ...
                <div class="flex flex-row ml-[10px] space-x-6 mb-[25px]">
                    ...
                    <div class=" flex flex-col items-center">
                        <p class="font-poppins font-semibold">THIRD PARTY LIABILITY</p>
                        <p class="font-poppins italic">(SUBJECT TO THE SCHEDULE OF INDEMNITIES AT THE BACK HEREOF
                        </p>
                        <p class="font-poppins italic">This Confirmation of Cover is evidence of policy of Insurance required under
                        </p>
                        <p class="font-poppins italic">Chapter VI Compulsory Motor Vehicle Liability Insurance of the Insurance code,
                        </p>
                ...
                <div class="flex flex-col">
                    <div class="flex flex-row space-x-4 ml-[10px]">
                        <label for="" class="font-poppins mt-[5px] mr-[15px]">Insured's Estimate of Value of Scheduled Vehicle</label>
                        <img src="../../assets/image/peso.png" alt="" class="w-[20px] h-[20px] mt-[4px]">
                        <input type="text"  class=" rounded-md w-[250px] py-[2px] px-[4px] placeholder:pl-[2px] placeholder:text-sm bg-white border-2 border-slate-300 focus:ring-1 focus:outline-none focus:border-lime-500 focus:ring-lime-500">
        ...
        <!-- <div class=" h-[500px] w-[900px] bg-white rounded-lg flex flex-col">
            <div class="flex flex-row  p-7">
                <label class="mb-4">Name
                    <input type="text" placeholder="Name" class="border rounded p-2 w-1/6">
                </label>
                <label class="mb-4">
                    Address
                    <input type="text" placeholder="Address" class="border border-black rounded p-2 w-1/6 ml-2">
                </label>
            </div>
            <div class="flex flex-row p-7">
                <label class="">Type of Body </label>
