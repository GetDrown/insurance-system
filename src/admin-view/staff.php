        ...
        <div class="px-2">
            ...
            <form action="../../phpscript/deletStaff.php" method="get" class="flex flex-col">
                ...
                <div class="flex justify-around items-center ">
                    ...
                    <button data-close-delete-modal
                        class="bg-red-300 py-2 px-1 rounded-lg font-medium w-[100px] shadow-md">
                        Cancel
                    </button>
                </div>
            </form>
            ...
            <form action="../../phpscript/editStaff.php" method="get" class="flex flex-col">
                ...
                <div class="h-[35px] flex mb-5">
                    <div
                        class="basis-1/5  bg-gray-700 flex justify-center items-center h-full text-white rounded-tl-md rounded-bl-md text-sm px-2">
                        Staff name</div>
                    <input type="text" name="editStaffName" id="editStaffName" value=""
                        class="basis-4/5  h-full border-2 px-3 py-2 rounded-tr-md rounded-br-md active:outline-none focus:outline-none">
                </div>
                <!-- username -->
                <div class="h-[35px] flex mb-5">
                    <div
                        class="basis-1/5  bg-gray-700 flex justify-center items-center h-full text-white rounded-tl-md rounded-bl-md text-sm px-2">
                        Username</div>
                    <input type="text" name="editStaffUserName" id="editStaffUserName"
                        class="basis-4/5  h-full border-2 px-3 py-2 rounded-tr-md rounded-br-md active:outline-none focus:outline-none">
                </div>
                <!-- password -->
                <div class="h-[35px] flex mb-5">
                    <div
                        class="basis-1/5  bg-gray-700 flex justify-center items-center h-full text-white rounded-tl-md rounded-bl-md text-sm px-2">
                        Password</div>
                    <input name="editStaffPassword" id="editStaffPassword" type="text"
                        class="basis-4/5  h-full border-2 px-3 py-2 rounded-tr-md rounded-br-md active:outline-none focus:outline-none">
                </div>
                <!-- buttns -->
                <div class="flex justify-around items-center ">
    ...
    <div class="basis-5/6  h-dvh p-3 rounded-lg overflow-hidden bg-gray-200 flex flex-col">
        ...
        <div class="h-[100px] w-full bg-white rounded-lg p-4 flex items-center justify-between mb-4 drop-shadow-md">
            <div>
                ...
                <p class="text-gray-500">Total Clients: <?php echo $totalStaff; ?></p>
        ...
        <div class="h-full rounded-md overflow-y-auto bg-white drop-shadow-md p-5 grid grid-cols-3 gap-5 relative"
            ...
            <div class="client bg-gray-600 h-[200px] rounded-md drop-shadow-md p-5 text-white">
                <div class="flex items-center justify-start border-b-2 border-gray-500 ">
                    ...
                    <div>
                        <input staffEditIdInputHidden type="hidden" class="border"
                        ...
                        <div class="flex justify-between items-center w-[250px] mt-2">
                            ...
                            <button name="editBtn" value="<?php echo $staff['user_id'];?>"
                                class="view-status-btn text-gray-400 font-medium text-[14px] data-open-status-modal editStaffBtn">
                                <i class="fa-solid fa-user-pen mr-3"></i> Edit Staff
                            </button>
                            <button name="delBtn" value="<?php echo $staff['user_id'];?>"
                                class="view-status-btn text-red-100 font-medium text-[14px] data-open-status-modal delStaffBtn">
