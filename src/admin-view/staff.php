            ...
            <form action="../../phpscript/addstaff.php" s method="POST" class="flex flex-col">
                ...
                <div class="flex justify-around items-center ">
                    <button type="submit" class="bg-lime-300 py-2 px-2 rounded-lg font-medium w-[100px] shadow-md">Add
                        Staff</button>
                    <button data-close-staff-modal class="bg-red-300 py-2 px-2 rounded-lg font-medium w-[100px] shadow-md">Cancel</button>
                </div>
            </form>
        </div>
    </dialog>
                    ...
                    <div class="flex items-center justify-start border-b-2 border-gray-500 ">
                        ...
                        <div>
                            ...
                            <div class="flex justify-between items-center w-[250px] mt-2">
                                <button data-index="<?php echo $i; ?>" class="view-status-btn text-gray-400 font-medium text-[14px] data-open-status-modal"> <i class="fa-solid fa-user-pen mr-3"></i> Edit Staff
                                </button>
                                <button data-index="<?php echo $i; ?>" class="view-status-btn text-red-100 font-medium text-[14px] data-open-status-modal"> <i class="fa-solid fa-user-minus  mr-3"></i></i> Delete Staff
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
                        ...
                        <div class="flex mt-3 justify-between items-center password-container">
                            ...
                            <div class="relative flex items-center">
                                <input type="password" class="password-field text-gray-500 bg-gray-100 rounded-md px-2 py-1 w-52 border border-gray-300" value="JaneDoe123123" disabled>
